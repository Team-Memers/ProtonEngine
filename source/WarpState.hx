...
class WarpState extends MusicBeatState
{
	...
	override function create()
	{
		...
		descText.setFormat('assets/fonts/vcr.ttf', 90, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	override function update(elapsed:Float)
	{
		...
		if(controls.ACCEPT) {
			...
			PlayState.SONG = Song.loadFromJson(canciones[curSelected][1] + '-hard', canciones[curSelected][1]);
