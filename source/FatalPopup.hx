    ...
    switch(type){
      case 1:
        clickDetector = new FlxSprite((88 + 34) * scale, (75 + 46) * scale);
				popup = new FlxSprite();
				popup.frames = FlxAtlasFrames.fromSparrow(FNFAssets.getBitmapData("assets/data/fatality/error_popups.png"), FNFAssets.getText("assets/data/fatality/error_popups.xml"));
